        ...
        */
        ...
        while ($row = mysqli_fetch_assoc($sqlstat)) {
            ...
            <a href='set.php?set_id=$setID'>
                <button type='button' class='btn btn-outline-success' style='margin-right: 40px;' onclick='get_nazev($setID)'>
                    " . $row["nazev"] . ' - ' . $row["jazyk"] . "
                </button>
            </a>
            <button type='button' class='btn btn-danger' style='position: absolute; top: 0; right: 0;' onclick='deleteSet($setID)'>
